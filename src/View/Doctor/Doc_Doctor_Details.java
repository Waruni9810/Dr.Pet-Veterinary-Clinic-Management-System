 ...
 */
public class Doc_Doctor_Details extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Dashboard
     */
    String uname;
    public Doc_Doctor_Details(String user_name) {
        initComponents();
            ...
            .addGroup(BackgroundLayout.createSequentialGroup()
                ...
                .addGroup(BackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(BackgroundLayout.createSequentialGroup()
                        ...
                        .addContainerGap(1025, javax.swing.GroupLayout.PREFERRED_SIZE))))
        );
 ...
 new doctordashboard(uname).setVisible(true);   
    ...
    private void MiniMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MiniMouseClicked
        // Minimize:
        this.setExtendedState(Doc_Doctor_Details.ICONIFIED);
    }//GEN-LAST:event_MiniMouseClicked

    private void MaxiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MaxiMouseClicked
        // Maximize:
        if(this.getExtendedState()!=Doc_Doctor_Details.MAXIMIZED_BOTH){
            this.setExtendedState(Doc_Doctor_Details.MAXIMIZED_BOTH);
        }
        else{
            this.setExtendedState(Doc_Doctor_Details.NORMAL);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Doc_Doctor_Details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            String user_name;
            public void run() {
                new Doc_Doctor_Details(user_name).setVisible(true);
            }
        });
    }
