...
//add database pharmacist records to the table           
ResultSet r = new Pharmacist_Searchtable().searchPharmacist();
DefaultTableModel dtm = (DefaultTableModel) phar_table.getModel();
...
int ph_count = phar_table.getRowCount();  //table count 
  count.setText(String.valueOf(ph_count)); //set count to the label 
    ...
    private void initComponents() {
        ...
        edit1.setForeground(new java.awt.Color(72, 100, 114));
        edit1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        edit1.setText("Edit Pharmacist");
        edit1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        edit1.setPreferredSize(new java.awt.Dimension(87, 19));
        ...
        delete.setText("Delete Pharmacist");
        ...
        add2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Image/icons8_pharmacist_25px_1.png"))); // NOI18N
        ...
        phar_table.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        panelRound12Layout.setHorizontalGroup(
            ...
            .addGroup(panelRound12Layout.createSequentialGroup()
                .addComponent(panelRound13, javax.swing.GroupLayout.DEFAULT_SIZE, 823, Short.MAX_VALUE)
                .addContainerGap())
        );
   ...
   new Admin_Dashboard(uname).setVisible(true);   //next interface
    ...
    new Add_Pharmacist().setVisible(true); //next interface
    }//GEN-LAST:event_addMouseClicked

    private void deleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteMouseClicked
 new Delete_Pharmacist_pop1().setVisible(true); //next interface
    ...
    new Edit_Pharmacist_Record(uname).setVisible(true); //next interface
